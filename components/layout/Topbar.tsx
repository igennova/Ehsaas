  ...
  return (
    <div className="flex z-50 justify-between items-center px-6 py-4 backdrop-blur-md sticky top-0 z-20]">
      ...
      <div className="max-md:hidden w-[400px] rounded-full flex">
        <input
          className="flex-grow border rounded-l-full outline-none text-sm pl-4 py-3"
          placeholder="Search for courses"
          value={searchInput}
          onChange={(e) => setSearchInput(e.target.value)}
        />
        <button
          className="bg-blue-200 rounded-r-full border-none outline-none cursor-pointer px-4 py-3 hover:bg-[#FDAB04]/80"
